        ...
        <div class="dashboard-content-container">
          ...
          <div class="main-content">
            ...
            <div class="lower-summarycards">
              <?php
                $getLatestClockQuery = "SELECT * FROM admin_employee_attendance WHERE employee_date = CURDATE() AND clock_in IS NOT NULL ORDER BY clock_in ASC LIMIT 2;";
              ...
              <div id="request-card" class="lowercard">
                ...
                <div class="request-card-content-container">
                  <div class="leave-person1">
                    <div class="person1-profile" style="background-image: url('<?=$firstImagePath ?? "../../Assets/default-user.png"?>');">
